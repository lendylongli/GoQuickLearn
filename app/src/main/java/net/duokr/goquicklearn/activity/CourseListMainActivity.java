...
public class CourseListMainActivity extends ActionBarActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.app_about_menu_item) {
            Intent intent = new Intent(CourseListMainActivity.this, AboutActivity.class);
            startActivity(intent);
            return true;
        } else if(id == R.id.app_profile_menu_item) {
            Intent intent = new Intent(CourseListMainActivity.this, MyProfileActivity.class);
            startActivity(intent);
            return true;
        }
